<template>
    <div class="main detail vendor" itemscope itemtype="http://schema.org/ProfessionalService">
        <div class="main-wrap avatar-cover">
            <aside class="main-left avatar">
                <avatar :vendor="vendor" itemprop="logo"></avatar>
            </aside>
            <section class="main-center cover">
            ...
            <aside class="main-left vendor-info r" v-if="vendor">
                <ul class="info">
                    ...
                    <li class="website"
                        v-if="vendor.website"
                        itemprop="url">
                        <a rel="nofollow" :href="'http://' + vendor.website" target="_black">{{vendor.website}}</a>
                    </li>
                    <meta itemprop="priceRange" content="1.000.000₫ - 10.000.000₫"/>
                </ul>
                <slot name="aside-left"></slot>
            </aside>
            <section class="main-center vendor-detail service-detail cr">
                <input class="hidden" id="cb_vendor_nav" type="checkbox">
                <ul class="vendor-nav r">
                ...
                <div class="vendor-explain service-info r">
                    <slot></slot>
                </div>
            </section>
        </div>
