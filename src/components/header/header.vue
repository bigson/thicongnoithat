    ...
    <div class="header-root">
        ...
        <header class="header header-nav sd">
            <div class="header-wrap">
                ...
                <label class="lb-search-popup" for="inputBtnSearchPopup">
        ...
        <div class="header-search-popup">
            <div class="search-header">
                ...
                <div class="wrap-input">
                    ...
                    <input id="inputSearchPopup" name="keyword" type="text" required placeholder="Nhập từ khóa tìm kiếm" v-model="search" autofocus>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                user         : USER_GETTER_DETAIL,
                categoriesPC : CATEGORIES_GETTER_PARENT_CHILDS,
            }),
            query(){
        ...
        beforeMount(){
            ...
            //     this.getCategories()
            //     console.log('beforeMount header', Object.assign({}, this.categories))
            // })
