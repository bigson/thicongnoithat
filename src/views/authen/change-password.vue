...
<script>
    import {USER_ACTION_POST_CHANGE_PASSWORD} from '@/store/actions.js'

    import {USER_MUTATION_SET_STATUS_CHANGE_PASSWORD} from '@/store/const/mutations.js'

    import {USER_GETTER_STATUS_CHANGE_PASSWORD} from '@/store/const/getters.js'
